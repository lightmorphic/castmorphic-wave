...
(async () => {
  ...
  if (!fs.existsSync(shotBg)) {
    execFileSync(FFMPEG, ['-hide_banner', '-loglevel', 'error', '-y',
      ...
      // orange rather than on a colour borrowed from an unrelated image.
      'gradients=s=2560x1440:n=3:c0=0x0C1220:c1=0x3F1607:c2=0xC4400F:x0=200:y0=1300:x1=2400:y1=140:d=1',
      '-frames:v', '1', shotBg]);
  }
